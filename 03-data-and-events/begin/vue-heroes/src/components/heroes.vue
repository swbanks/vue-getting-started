          ...
          <div class="card-content">
            <div class="content">
              ...
              <div class="field">
                ...
                <label class="radio" for="color-purple">
                  <input type="radio" id="color-purple" value="purple" v-model="hero.capeColor"/>
                  purple
                </label>
                <label class="radio" for="color-aquamarine">
                  <input type="radio" id="color-aquamarine" value="aquamarine" v-model="hero.capeColor"/>
                  aquamarine
                </label>
